...
import (
	...
	insertion_sort "github.com/JMOrbegoso/algorithms-in-go/sorting-algorithms/insertion-sort"
)
...
func main() {
	...
	fmt.Println("3. Fibonacci Sequence")
	fmt.Println("4. Fibonacci Sequence using Memoization")
	...
	for input.Scan() {
		...
		case "2":
			a = insertion_sort.Insertion_Sort{}
		case "3":
