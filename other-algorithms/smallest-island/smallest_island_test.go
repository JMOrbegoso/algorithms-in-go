...
func TestGetSmallestIslandNoLand(t *testing.T) {
	// Arrange
	grid := createGrid(6, 6)

	// Act
	output := getSmallestIsland(grid)
...
func TestGetSmallestIsland(t *testing.T) {
	// Arrange
	grid := createGrid(6, 6)
...
func TestExploreIsland(t *testing.T) {
	// Arrange
	grid := createGrid(3, 3)
	var visited []string
	...
	// Act
	output := exploreIsland(grid, 0, 1, &visited)
